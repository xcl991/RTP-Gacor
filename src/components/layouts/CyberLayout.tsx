        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              />
              <div>
                <h1 className={`${getFontSizeClass()} font-bold font-mono text-white`}>{customHeaderText}</h1>
              </div>
            </div>
            <div className="text-right font-mono">
              <div className="text-base" style={{ color: primaryColor }}>[{getCurrentDate()}]</div>
              <div className="text-base font-bold text-white">{customTimeLabel}</div>
            </div>
          </div>
        </div>
      </div>
