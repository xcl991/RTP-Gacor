  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 p-3">
        ...
        {/* Game Image */}
        <div className="relative w-16 h-16 flex-shrink-0 overflow-hidden rounded" style={{ border: `1px solid ${primaryColor}40` }}>
          <img
            src={game.src}
            alt={game.name}
...
export default function CyberpunkLayout2({
  ...
  return (
    <div className="relative z-10 flex flex-col min-h-full p-6" style={{ fontFamily: 'monospace' }}>
      ...
      <div
        className="relative z-10 mb-6 p-4"
        style={{
      ...
      <div className="flex items-center gap-2 my-4">
        ...
        <span className="font-mono text-xs px-3" style={{ color: primaryColor }}>
          // SWITCHING_PROVIDER
        </span>
        <div className="flex-1 h-px" style={{ background: primaryColor }} />
      </div>
      ...
      <div className="relative z-10 mt-auto">
        <div
          className="flex items-center justify-center gap-4 p-3 font-mono"
          style={{
        ...
        >
          ...
          <span style={{ color: primaryColor }}>
            CONNECT: @{selectedWebsite.name.toUpperCase().replace(/[^A-Z0-9]/g, '')}
          </span>
