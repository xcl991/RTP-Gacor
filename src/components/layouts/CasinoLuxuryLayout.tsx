...
function CasinoGameCard({ game, rtp, primaryColor, secondaryColor, isShowcase = false }: CasinoGameCardProps) {
  return (
    <div
      className={`relative overflow-hidden ${isShowcase ? 'w-[220px]' : 'w-[180px]'}`}
      style={{
    ...
    >
      ...
      <div className={`relative w-full ${isShowcase ? 'aspect-square' : 'aspect-square'} overflow-hidden`}>
        <img
          src={game.src}
          alt={game.name}
  ...
  return (
    <div className="relative z-10 flex flex-col min-h-full p-6" style={{ fontFamily: 'var(--font-cinzel), serif' }}>
      ...
      <div
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M40 0L80 40L40 80L0 40z' fill='${encodeURIComponent(primaryColor)}' fill-opacity='0.3'/%3E%3Ccircle cx='40' cy='40' r='15' fill='none' stroke='${encodeURIComponent(secondaryColor)}' stroke-opacity='0.2'/%3E%3C/svg%3E")`,
      ...
      <div className="relative z-10 mb-8">
        <div
          className="flex items-center justify-center gap-4 mb-6 p-4 rounded-xl"
          style={{
        ...
        >
          ...
          <img
            ...
            alt="Pragmatic Play"
          />
          <span className="text-xl font-semibold tracking-wider" style={{ color: primaryColor }}>PRAGMATIC PLAY</span>
          <div className="text-2xl" style={{ color: primaryColor }}>♠</div>
        </div>
      ...
      <div className="relative z-10 mb-8">
        ...
        >
          ...
          <img
            ...
            alt="PG Soft"
          />
          <span className="text-xl font-semibold tracking-wider" style={{ color: secondaryColor }}>PG SOFT</span>
          <div className="text-2xl" style={{ color: secondaryColor }}>♣</div>
        </div>
        <div className="flex flex-wrap justify-center gap-4">
