...
function GalaxyGameCard({ game, rtp, primaryColor, secondaryColor }: GalaxyGameCardProps) {
  ...
  return (
    <div
      className="relative overflow-hidden w-[180px] rounded-xl"
      style={{
    ...
    <div className="relative z-10 flex flex-col min-h-full p-6" style={{ fontFamily: 'var(--font-orbitron), sans-serif' }}>
      ...
      <div
        ...
        style={{
          backgroundImage: `
            ...
            radial-gradient(2px 2px at 40px 70px, ${secondaryColor}, transparent),
            radial-gradient(1px 1px at 90px 40px, white, transparent),
            radial-gradient(2px 2px at 130px 80px, ${primaryColor}, transparent),
            radial-gradient(1px 1px at 160px 120px, white, transparent),
            radial-gradient(2px 2px at 200px 60px, ${secondaryColor}, transparent)
          `,
      ...
      <div className="relative z-10 mb-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <span className="text-lg font-semibold" style={{ color: primaryColor }}>PRAGMATIC PLAY</span>
        </div>
      ...
      <div className="relative z-10 mb-8">
        <div className="flex items-center gap-4 mb-6">
          <img
            ...
            className="h-16"
            style={{ filter: `drop-shadow(0 0 15px ${secondaryColor}cc)` }}
            alt="PG Soft"
          />
          <div className="flex-1 h-1 rounded" style={{ background: `linear-gradient(90deg, ${secondaryColor}, transparent)` }} />
          <span className="text-lg font-semibold" style={{ color: secondaryColor }}>PG SOFT</span>
        </div>
        <div className="flex flex-wrap justify-center gap-4">
